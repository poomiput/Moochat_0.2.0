...
extension RandomUsernameGenerator on String {
  ...
  /// Generates a moo-themed random username
  static String generatemooUsername() {
    final List<String> mooPrefixes = [
      'moo',
      'palestine',
      'free',
      'hope',
    ...
    final Random random = Random();
    final String prefix = mooPrefixes[random.nextInt(mooPrefixes.length)];
