...
import 'package:moochat/features/chat/ui/widgets/image/image_message_bubble.dart';
import 'package:moochat/features/chat/ui/widgets/voice/voice_message_bubble.dart';
import 'package:moochat/features/chat/ui/widgets/video/video_message_bubble.dart';
...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Use specialized image bubble for image messages
    if (message.type == MessageType.image) {
      return ImageMessageBubble(message: message, showAvatar: !isConsecutive);
    }

    // Use specialized voice bubble for voice messages
    if (message.type == MessageType.voice) {
      return VoiceMessageBubble(message: message, showAvatar: !isConsecutive);
    }
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isMe
                      ? const Color(0xffFABAC7).withOpacity(0.9)
